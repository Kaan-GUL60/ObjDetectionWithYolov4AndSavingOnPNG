...
print(classNames)
def fonkfonk(image_no):
    sayi = 1
    img = cv2.imread(rf"C:\Users\{os.getlogin()}\Downloads\{image_no}.png")
    ...
    for max_id in max_ids:
        ...
        if sayi == 1:
            ...
            cv2.imwrite(rf"kesilmis/{image_no}.png",kesilen_soru)
        elif sayi == 2:
            confidence = confidences_list[max_class_id]
            ...
            kesilen_soru = img[start_y:end_y, start_x:end_x]
            # img_taslak[start_y+200:end_y+200, start_x:end_x] = kesilen_soru


            cv2.imwrite(rf"kesilmis/{image_no}_2.png", kesilen_soru)
